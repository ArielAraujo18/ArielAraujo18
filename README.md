# Ariel Santos
### Full Stack Developer | ERP Systems, APIs, Geospatial Solutions and Automation
...
Python automation bot for receiving external data and sending real-time messages to groups.
...
### REST API
REST API built with Node.js implementing CRUD operations.
